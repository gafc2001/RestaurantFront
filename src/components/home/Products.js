...
const orderSubmit = (order) => {
  ...
  return (
    ...
    <div className="parent">
      ...
      <div className={`column-2 bg-primary products ${toggleCart?"toggleOrderLeft":"toggleOrderRight"} ${togglePayment?"togglePaymentRight":""}`}>
            ...
            <div className="payment-user-info">
              <div className="form-group">
                ...
                <div className="input-container">
                  <input type="text" className="input" placeholder="Su nombre"/>
                </div>
              </div>
              <div className="form-group">
              ...
              <div className="form-group">
                ...
                <div className="input-container">
                  <input type="text" className="input" placeholder="Ejmp: Av. Faucett Cdr. 5"/>
                </div>
              </div>
              <div className="form-group">
                <label className="label">Telefono</label>
                <div className="input-container">
                  <input type="text" className="input" placeholder="Su Telefono"/>
                </div>
              </div>
            </div>
          </div>
          <div className="btn-container">
            <button type="button" className="btn btn-secondary" onClick={() => setTooglePayment(false)}>Cancelar</button>
            <button type="button" className="btn btn-primary">Confirmar pago</button>
          </div>
        </div>
      </div>
    </div>
