...
const ProductItem = ({ el, setDataToEdit, deleteData }) => {
  let {
    description,
    availableProduct,
    priceProduct,
    ...
    <div class="product product-item">
      <div class="product-content">
        ...
        <div class="product-info">
          ...
          <span class="product-details"><span>${priceProduct}</span> &bull; <span>Available</span></span>
        </div>
      </div>
      <div class="btn-product center" onClick={() => setDataToEdit(el)}>
        <span>
